export const metadata = {
  title: 'Overview',
  description:
    'In this guide, we’ll look at how overview works. Protocol offers two ways to authenticate your API requests: Basic overview and OAuth2 with a token.',
}

# Overview

You'll need to authenticate your requests to access any of the endpoints in the Protocol API. In this guide, we'll look at how overview works. Protocol offers two ways to authenticate your API requests: Basic overview and OAuth2 with a token — OAuth2 is the recommended way. {{ className: 'lead' }}

## Basic overview

With basic overview, you use your username and password to authenticate your HTTP requests. Unless you have a very good reason, you probably shouldn't use basic auth. Here's how to authenticate using cURL:
